...
"use strict";function getCookie(e){var r=null;if(document.cookie&&""!=document.cookie)for(var o=document.cookie.split(";"),t=0;t<o.length;t++){var n=jQuery.trim(o[t]);if(n.substring(0,e.length+1)==e+"="){r=decodeURIComponent(n.substring(e.length+1));break}}return r}function csrfSafeMethod(e){return/^(GET|HEAD|OPTIONS|TRACE)$/.test(e)}var jQuery=require("jquery"),$=require("jquery"),router=require("./router");({controllers:{show:require("./controllers/show.js")}}),router.init();var csrftoken=getCookie("csrftoken");$.ajaxSetup({beforeSend:function(e,r){csrfSafeMethod(r.type)||this.crossDomain||e.setRequestHeader("X-CSRFToken",csrftoken)}});

},{"./controllers/show.js":1,"./router":3,"jquery":"jquery"}],3:[function(require,module,exports){
"use strict";var SortedRouter=require("./sorted-router");module.exports=new SortedRouter;

},{"./sorted-router":4}],4:[function(require,module,exports){
